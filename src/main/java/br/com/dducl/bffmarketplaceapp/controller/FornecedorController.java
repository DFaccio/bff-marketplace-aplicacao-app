...
public class FornecedorController {
    ...
    @GetMapping(value = "/{id}")
    public ResponseEntity<FornecedorDto> findById(@PathVariable Integer id) throws ValidationsException {
    ...
    public ResponseEntity<FornecedorDto> findByIdentificador(@PathVariable String identificador) throws ValidationsException {
